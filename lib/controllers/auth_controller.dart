...
class AuthController extends GetxController {
  ...
  bool get isintinalized => _isinitialized.value;
  ...
  //     }
  //   } else {
  //     if (Get.currentRoute != AppRoutes.profile) {//profile
  //       Get.offAllNamed(AppRoutes.profile); //profile
  //     }
  //   }
  ...
  Future<void> registerWithEmailAndPassword(String email, String password, String displayName)async{
    try {
      ...
      UserModel? userModel = await _authService.registerInWithEmailAndPassword(
        email,
        password,
        displayName,
      );
