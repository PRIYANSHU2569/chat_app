...
class HomeView extends GetView<HomeController> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text(
                'No ${controller.activeFilter.toLowerCase()} conversations found',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w500,
                  color: AppTheme.textSecondaryColor,
  ...
  String _getFilterEmptyMessage(String filter) {
    switch (filter) {
      case 'Unread':
        return 'All your conversation are up to date';
      case 'Recent':
        return 'No conversation from the last 3 days';
      case 'Active':
        return 'No conversation from the last week';
      default:
